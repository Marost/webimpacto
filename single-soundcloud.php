...
<html lang="en" class="no-js">
    <head>
        ...
        <link rel="stylesheet" href="http://code.jquery.com/ui/1.10.4/themes/smoothness/jquery-ui.css" media="all">
            ...
            <div class="row">
                    ...
                    <div id="main-content">
                            ...
                            <div class="clearfix">
                                <aside class="pull-left">
                                    <div class="entry-meta">
                                        <span class="kopa-user"><i class="fa fa-user"></i>By Anh Tuan</span>
                                    ...
                                    <!-- entry meta -->
                                    <div class="clearfix">
                                        <h4 class="post-cat"><a href="#">entertaiment</a></h4>
                                    ...
                                    <div class="admin-rating">
                                        ...
                                        <div class="kopa-progressbar" data-val="90">
                                            <span class="val-t">Location</span>
                                        </div>
                                        <div class="kopa-progressbar" data-val="75">
                                            <span class="val-t">Travel</span>
                                        </div>
                                        <div class="kopa-progressbar" data-val="60">
                                            <span class="val-t">Package</span>
                                        </div>
                                ...
                                <div class="item-right article-content">
                                    <div class="post-thumb">
                                        <iframe width="100%" height="166" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/116442722"></iframe>
                                    </div>
                                    <!-- post thumb -->
                        ...
                        <div class="kopa-author">
                            <div class="widget-content clearfix" itemscope itemtype="http://data-vocabulary.org/Person">
                                <div class="author-thumb img-responsive pull-left">
                                    <img src="placeholders/posts/69.jpg" alt="">
                                </div>
                                <div class="item-right">
                                    <h4 class="author-title"><span itemprop="name">Admin</span></h4>
                        ...
                        <ul class="pager-page list-unstyled clearfix">
                            <li class="prev-post pull-left">
                                <h4 class="prev"><i class="fa fa-angle-double-left"></i><a href="#" >Previous article</a></h4>
                                <h4 class="post-title"><a href="#">In hac habitasse platea dictumst. Morbi sed nisi est</a></h4>
                                <span class="kopa-date">Fer 20, 2014</span>
                                <a href="#" class="post-cat">FASHION</a>
                            </li>
                            <li class="next-post pull-right">
                                <h4 class="next"><a href="#">Next Article</a><i class="fa fa-angle-double-right"></i></h4>
                                <h4 class="post-title"><a href="#">US labour market shows strong rise: 236,000</a></h4>
                                <span class="kopa-date">Fer 20, 2014</span>
                                <a href="#" class="post-cat">FASHION</a>
                            </li>
                        </ul>
                        <div id="comments">
                                ...
                                <li class="comment">
                                    <article class="comment-body">
                                        <figure class="pull-left">
                                            <img src="placeholders/posts/70.jpg"  alt="">
                                        </figure>
                                        <div class="comment-content item-right">
                                            <header class="clearfix">
                                                <h4>Jolie Angelina</h4>
                                                <p class="kopa-metadata">10 September, 2013 at 5:26 pm</p>
                                                <p class="reply-edit"><a href="#">Edit</a> / <a href="#">Reply</a></p>
                                            </header>
                                            <div class="entry-content">
                                                <p>Etiam varius dui eget lorem elementum eget mattis sapien interdum. In hac habitasse platea dictumst. Morbi sed nisi est, vitae convallis nulla. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                            </div>
                            ...
                            <div id="respond">
                                ...
                                <form action="/" method="post" class="comment-form clearfix">
                                    <p class="comment-notes">Your email address will not be published. Required fields are marked <span>(required )</span></p>
                                    <div class="row">
                                    ...
                                    <!-- row -->
                                    <p class="form-submit">
                                        <input type="submit" class="input-submit" value="Post comment">
                                    </p>
                                </form>
                                <div id="response"></div>
                            </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div id="sidebar" class="widget-area-26">
                            ...
                            <div class="widget-content">
                                <div class="item-post latest-post">
                                    <div class="video-wrapper">
                                        <iframe width="420" height="315" src="http://www.youtube.com/embed/jALI74x_fqA" frameborder="0" allowfullscreen></iframe>
                                    </div>
                                </div>
                                <!-- item-post -->
                                <div class="item-post">

                                    <h4 class="post-title"><a href="#"><i class="fa fa-youtube-play"></i>Live Now: Convene Founder Answers Questions via Video.</a></h4>
                                </div>
                                <!-- item-post -->
                                <div class="item-post">
                                    <h4 class="post-title"><a href="#"><i class="fa fa-youtube-play"></i>Live Now: Convene Founder Answers Questions via Video.</a></h4>
                        ...
                        <div class="widget kopa-social-2-widget">
                            <div class="widget-content">
                                <div class="link-social-2">
                                    <a href="#"><i class="fa fa-twitter"></i>Twitter</a>
                                    <a href="#"><i class="fa fa-facebook"></i>Facebook</a>
                        ...
                        <div class="widget kopa-list-posts-thumb-medium-widget">
                            ...
                            <div class="widget-content">
                                <div class="item-post">
                                    <a href="#" class="post-thumb img-responsive">
                                        <img src="placeholders/posts/38.jpg" alt="">
                                        <div class="mask2"></div>
                                    </a>
                                    <div class="item-content">
                                        <h4 class="post-title"><a href="#">How to use a website to strengthen a brand</a></h4>
                                            <span class="kopa-rate">
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
                                ...
                                <div class="item-post">
                                    <a href="#" class="post-thumb img-responsive">
                                        <img src="placeholders/posts/39.jpg" alt="">
                                        <div class="mask2"></div>
                                    </a>
                                    <div class="item-content">
                                        <h4 class="post-title"><a href="#">How to use a website to strengthen a brand</a></h4>
                                ...
                                <div class="item-post">
                                    <a href="#" class="post-thumb img-responsive">
                                        <img src="placeholders/posts/40.jpg" alt="">
                                        <div class="mask2"></div>
                                    </a>
                                    <div class="item-content">
                                        <h4 class="post-title"><a href="#">How to use a website to strengthen a brand</a></h4>
                                ...
                                <div class="item-post">
                                    <a href="#" class="post-thumb img-responsive">
                                        <img src="placeholders/posts/41.jpg" alt="">
                                        <div class="mask2"></div>
                                    </a>
                                    <div class="item-content">
                                        <h4 class="post-title"><a href="#">How to use a website to strengthen a brand</a></h4>
                        ...
                        <div class="widget kopa-ads-widget">
                            <div class="widget-content">
                                <a href="#"><img src="placeholders/ads/2.jpg" alt=""></a>
                            </div>
                        </div>
                        <!-- ads widget -->
