        ...
        <div class="container">
            ...
            <div class="widget-area-27">
                <div class="single-page-content">
                        ...
                        <div class="widget-content">
                            <div class="row">
                                <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12 pull-right">
                                    <div class="kopa-map">
                                        <div id="kopa-map" class="map-wrap" data-latitude="21.029532" data-longitude="105.852345">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="post-content">
                                        ...
                                        <ul class="list-unstyled">
                                            <li>
                                                ...
                                                <h5>Email:</h5>
                                                <a href="mailto:kopasof@gmail.com">kopatheme@gmail.com</a>
                                            </li>
                                            <li>
                                                <i class="fa fa-phone"></i>
                                                <h5>Phone:</h5>
                                                <span>(+84) 740-349-0600</span>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <i class="fa fa-phone"></i>
                                                <h5>Address:</h5>
                                                <span>8775 Georgetown Road, Cambridge, Ohio, 43725, USA</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <!-- kopa contact widget -->
                    <div id="respond">
                        <h3 class="comment-reply-title">SEND TO US A MESSAGE</h3>
