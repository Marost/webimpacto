        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    <div id="main-content">
                        <div class="widget kopa-single-gallery-widget">
                            ...
                            <div class="widget-content clearfix">
                                <div class="owl-carousel sync1">
                                    <div class="item">
                                        <a href="#" class="img-responsive">
                                            <img src="placeholders/posts/63.jpg" alt="">
                                        </a>
                                    </div>
                                    <!-- item -->
                                    <div class="item">
                                ...
                                <div class="owl-carousel sync2">
                                    <div class="item img-responsive">
                                        <img src="placeholders/posts/60.jpg" alt="">
                                    </div>
                                    <!-- item -->
                                    <div class="item img-responsive">
                                        <img src="placeholders/posts/61.jpg" alt="">
                                    </div>
                                    <!-- item -->
                                    <div class="item img-responsive">
                                        <img src="placeholders/posts/62.jpg" alt="">
                                    </div>
                                    <!-- item -->
                                    <div class="item img-responsive">
                                        <img src="placeholders/posts/62.jpg" alt="">
            ...
            <div class="widget-area-27">
                    ...
                    <div class="widget-content clearfix">
                        <div class="item">
                            <div class="post-thumb">
                                <a href="#" class="img-responsive">
                                    <img src="placeholders/posts/57.jpg" alt="">
                                </a>
                                <a href="#" class="fa fa-play post-format"></a>
                                <span class="kopa-date">Fer 20, 2014</span>
                            </div>
                            <!-- post thumb -->
                            <div class="item-content">
                                <h4 class="post-title">
                                    <a href="#">‘The Wolverine’ review: a samurai redemption story </a>
                        ...
                        <div class="item">
                            <div class="post-thumb">
                                <a href="#" class="img-responsive">
                                    <img src="placeholders/posts/58.jpg" alt="">
                                </a>
                                <a href="#" class="fa fa-play post-format"></a>
                                <span class="kopa-date">Fer 20, 2014</span>
                            </div>
                        ...
                        <div class="item">
                            <div class="post-thumb">
                                <a href="#" class="img-responsive">
                                    <img src="placeholders/posts/59.jpg" alt="">
                                </a>
                                <a href="#" class="fa fa-play post-format"></a>
                                <span class="kopa-date">Fer 20, 2014</span>
                            </div>
                ...
                <!-- kopa-list-posts-masonry-2-widget -->
                <div class="widget kopa-list-posts-2-widget">
                    <header class="widget-header">
                        <h3 class="widget-title">latest audio</h3>
                        <i class="fa fa-plus-square-o"></i>
                    </header>
                    <div class="widget-content clearfix">
                        <div class="item">
                            <div class="post-thumb">
                                ...
                                <a href="#" class="fa fa-volume-down post-format"></a>
                                <span class="kopa-date">Fer 20, 2014</span>
                            </div>
                            <!-- post thumb -->
                            <div class="item-content">
                ...
                <div class="widget kopa-list-posts-2-widget">
                    <header class="widget-header">
                        <h3 class="widget-title">latest gallery</h3>
                        <i class="fa fa-plus-square-o"></i>
                    </header>
                    <div class="widget-content clearfix">
                        <div class="item">
                            <div class="post-thumb">
                                ...
                                <a href="#" class="fa fa-picture-o post-format"></a>
                                <span class="kopa-date">Fer 20, 2014</span>
                            </div>
                            <!-- post thumb -->
                            <div class="item-content">
