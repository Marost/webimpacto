...
$id_url=$_REQUEST["id"];
$url=$_REQUEST["url"];
$url_web=$web."edicion-anterior-fr";
...
$rst_noticias   = mysql_query("SELECT COUNT(*) as count FROM iev_edicion_fr WHERE fecha_publicacion<='$fechaActual' ORDER BY fecha_publicacion DESC;", $conexion);
...
$rst_noticias   = mysql_query("SELECT * FROM iev_edicion_fr WHERE fecha_publicacion<='$fechaActual' ORDER BY fecha_publicacion DESC LIMIT $start, 16", $conexion);
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Édition précédente: Frances</title>
                ...
                <section id="edicion-anterior">
                    ...
                    <section class="categoria">
                        ...
                        <?php while($fila_noticias=mysql_fetch_array($rst_noticias)){
                                ...
                                //URL
                                $noticia_urlFinal=$web."revista_fr/".$noticia_titulo."/index.html";
                        ?>
