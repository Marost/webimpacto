...
// Data Gathering
$params['sql_query']                = "SELECT id, titulo,  nombre_edicion FROM ".$tabla_suf."_edicion_europa AS noti ORDER BY fecha_publicacion DESC, id DESC";
...
<div id="content">
    <div class="contentTop">
        <span class="pageTitle"><span class="icon-screen"></span>Edición Europa</span>
    </div>
    ...
    <div class="wrapper">
        ...
        <!-- Media table sample -->
        <div class="widget">
            <div class="whead"><h6>Edición Europa</h6></div>
