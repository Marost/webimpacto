...
//PUBLICAR
if ($_POST["publicar"]<>""){ $publicar=$_POST["publicar"]; }else{ $publicar='D'; }

//INSERTANDO DATOS
$rst_guardar=mysql_query("UPDATE ".$tabla_suf."_saludos 
	SET nombre='$nombre', 
	contenido='$contenido',
	pais='$pais',
	fecha='$fecha',
	registro_ip='$email',
	estado_saludo='$publicar'
	WHERE id=$nota_id;", $conexion);
