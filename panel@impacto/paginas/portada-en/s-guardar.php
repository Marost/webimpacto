...
//INSERTANDO DATOS
$rst_guardar=mysql_query("INSERT INTO ".$tabla_suf."_edicion_en (url, titulo, nombre_edicion, imagen, fecha_publicacion) 
	VALUES('$edicion_numero', '$edicion_numero', '$edicion_nombre', '$name', '$fecha_publicacion');",$conexion);
