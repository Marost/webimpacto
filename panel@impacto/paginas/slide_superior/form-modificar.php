...
$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_slide_superior WHERE id=". $_REQUEST["id"].";", $conexion);
            ...
            <tr>
                ...
                <form action="actualizar.php?id=<?php echo $_REQUEST["id"]; ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
            	  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
            	    ...
            	    <tr>
            	      <td align="right"><p><strong>Titulo:</strong></p></td>
            	    ...
            	    <tr>
                      ...
                      <img src="../../../imagenes/upload/<?php echo $fila_query["carpeta_imagen"]."thumb/".$fila_query["imagen"] ?>" width="150" />
           	          <input name="imagen_actual" type="hidden" id="imagen_actual" value="<?php echo $fila_query["imagen"] ?>" />
           	          <input name="carpeta" type="hidden" id="carpeta" value="<?php echo $fila_query["carpeta_imagen"] ?>" /></td>
          	      </tr>
            	    <tr>
