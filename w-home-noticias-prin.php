...
//NOTICIAS DERECHA
$rst_notNor=mysql_query("SELECT * FROM iev_noticia WHERE destacada=0 AND categoria<>4 AND categoria<>6 AND categoria<>7 AND categoria<>8 AND categoria<>13 AND categoria<>14 AND fecha_publicacion<='$fechaActual' AND publicar=1 ORDER BY fecha_publicacion DESC LIMIT 3", $conexion);
