...
//TAGS
$rst_tags=mysql_query("SELECT * FROM iev_noticia_tags WHERE id=$id_url", $conexion);
...
$rst_noticias        = mysql_query("SELECT COUNT(*) as count FROM iev_noticia WHERE tags LIKE '%,$id_url,%' AND publicar=1 AND fecha_publicacion<='$fechaActual' ORDER BY fecha_publicacion DESC, id DESC", $conexion);
...
$rst_noticias        = mysql_query("SELECT * FROM iev_noticia WHERE tags LIKE '%,$id_url,%' AND publicar=1 AND fecha_publicacion<='$fechaActual' ORDER BY fecha_publicacion DESC, id DESC LIMIT $start, 10", $conexion);
